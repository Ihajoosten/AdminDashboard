	...
	<div class="modal-card">
		<section class="modal-card-body">
			...
			<div class="box">
				...
				<button class="button is-dark is-large is-fullwidth" v-on:click="login()">Login</button>
			</div>
			<div class="has-text-centered">
				Not an account yet? <button class="button is-primary is-small" v-on:click="openRegisterModal()">Sign up</button> here
			</div>
		</section>
	</div>
</template>
